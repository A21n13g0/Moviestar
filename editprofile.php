    ...
    <div class="col-md-12">
        <form action="<?= $BASE_URL ?>user_process.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div id="profile-image-container" style="background-image: url('<?= $BASE_URL ?>img/users/<?= $userData->imageUser; ?>')"></div>
                    <div class="form-group">
                        <label for="image">Foto</label>
                        <input type="file" class="form-control-file" id="image" name="image">
                    </div>
                    <div class="form-group">
                        <label for="biography">Sobre você</label>
                        <textarea class="form-control" name="biography" id="biography" rows="5" placeholder="Conte sobre você"><?= $userData->biography; ?></textarea>
                    </div>
                </div>
            </div>
        </form>
            ...
            <div class="col-md-4">
                ...
                <form action="<?= $BASE_URL ?>user_process.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="confirmpassword" name="confirmpassword" placeholder="Digite a nova senha novamente">
                    </div>
